...
En la \ref{fig:metricasPorPersona} se observa que siete de ocho personas tienen una precisión de seguimiento por arriba del 80\%, por lo tanto, la precisión total del sistema para ese video es de 87.5\%. 
